#############################################################################
# Makefile for building: QTry
# Generated by qmake (3.0) (Qt 5.0.1) on: Di. Dez. 17 19:42:56 2013
# Project:  QTry.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile QTry.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-64 -I. -I. -I/usr/include/qt5/QtWidgets -I/usr/include/qt5 -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
Makefile: QTry.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/QTry1.0.0 || $(MKDIR) .tmp/QTry1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QTry1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/QTry1.0.0/ && (cd `dirname .tmp/QTry1.0.0` && $(TAR) QTry1.0.0.tar QTry1.0.0 && $(COMPRESS) QTry1.0.0.tar) && $(MOVE) `dirname .tmp/QTry1.0.0`/QTry1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QTry1.0.0
